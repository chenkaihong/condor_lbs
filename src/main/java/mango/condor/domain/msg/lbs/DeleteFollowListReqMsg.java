 ...
 * @Date 2013-7-16 上午10:11:48
 * @Description 
 */
public class DeleteFollowListReqMsg extends LBSRequestMessage {
	
	private int hisServerId;
	private int hisId;
	
	public DeleteFollowListReqMsg() {
		super(LBSMessageDefine.LBS_DELETE_FOLLOWLIST_REQUEST);
	}
